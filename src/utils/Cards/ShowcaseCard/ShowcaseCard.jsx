        ...
        <div className={css.innerDiv}>
            ...
            <div className={css.txtBox}>
                ...
                <div className={css.tagBox}>
                    ...
                    <div className={css.tagTxt}>₹<span className={css.type}>3500</span> for <span className={css.num}></span></div>
                </div>
            </div>
            <div className={css.footer}>
                <div className={css.scroll1}>
                    <div className={css.lg1}><img className={css.upArrow} src={upArrowIcon} alt="gorwing arrow" /></div>
                    <div className={css.ordersPlaces}>100+ Bookings today!</div>
                ...
                <div className={css.scroll2}>
                    ...
                    <div className={css.ordersPlaces}>Hottest party in town!</div>
